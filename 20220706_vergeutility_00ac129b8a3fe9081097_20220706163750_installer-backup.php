...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220706_vergeutility_00ac129b8a3fe9081097_20220706163750_archive.zip';
	const ARCHIVE_SIZE		 = '57502269';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '00ac129-06163750';
    const SECONDARY_PACKAGE_HASH = 'f572726-06163750';
	const VERSION			 = '1.4.7';
